		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row top-nav">
					<div class="col-lg-12">
						<a href="http://www.ibm.com/smarterplanet/us/en/ibmwatson/developercloud/text-to-speech.html" class="left">Learn more about this service</a>
						<a href="https://github.com/watson-developer-cloud/text-to-speech-java" class="right fork">Fork</a>
						<a href="mailto:watsondevelopercloud@ibm.com" class="right">Contact Us</a>
				...
				<div style="padding-bottom:0px;" class="row header">
					...
					<div class="col-lg-4 col-xs-4">
						...
						<a href="http://www.ibm.com/smarterplanet/us/en/ibmwatson/developercloud/doc/text-to-speech/" class="left">Documentation</a>
						<a href="http://www.ibm.com/smarterplanet/us/en/ibmwatson/developercloud/apis/#!/text-to-speech" class="right">API Details</a>
					</div>
				</div>
			</div>
		</div>
						...
						<fieldset>
							<div class="row">
								<div class="col-lg-12 col-xs-12">
									...
									<textarea id="textArea" name="text" rows="8" required class="form-control">
The Text to Speech service uses IBM's speech synthesis capabilities
to convert English or Spanish text to an audio signal.
The audio is streamed back to the client with minimal delay.
The service can be accessed via a REST interface.
									</textarea>
									<span class="help-block">
										<small>
											The text language must match the selected voice language: If you pronounce Mixing language (English text with a Spanish voice) does not produce valid results.
										</small>
									</span>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-12 col-xs-12">
						<div style="display:none" class="well result">
							...
							<div>
								<span class="help-block">
									The synthesized audio is streamed to the client as it is being produced, using the HTTP chunked encoding. The audio is returned in the <a href="http://www.vorbis.com/">Ogg Vorbis</a> format which can be played using <a href="http://www.videolan.org/vlc/index.html">VLC</a>, <a href="http://audacity.sourceforge.net/">Audacity</a> and many other players.
								</span>
							</div>
						</div>
